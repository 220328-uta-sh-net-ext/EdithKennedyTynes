...
// creating an instance of the class using constructor(name, species)
...
//must implement abstract method drive from class car
...
let user1:User; // setting the variable then initializing the variable
