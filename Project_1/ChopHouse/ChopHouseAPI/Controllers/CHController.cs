...
namespace ChopHouseAPI.Controllers
{
    ...
    public class CHController : ControllerBase // Controller base class has the logic to interact with HTTP and communication with client  
    {
        ...
        {
            new ChopHouse {StoreID = 9632, Name = "Golden Dragon", City = "Norfolk", State = "VA" ,},
        ...
        /// </summary>
        /// <returns></returns>
        //Authenticate user 401 error code if not authorized, placing here none of the methods will be visible
